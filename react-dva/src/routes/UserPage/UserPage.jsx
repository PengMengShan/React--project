...
import normalAvatar from '../../img/pms.jpg';
import superAvatar from '../../img/bj.jpg';
            ...
            <Row className={styles.mainContainer}>
                <Col span={8} xs={0} sm={8} md={8} lg={8}>
                    <div className={styles.title}>
                        <h1><Icon type="user" className={styles.icon}/>{isSelf ? '我' : '其他人'}的简介</h1>
                    </div>
                    <Affix offsetTop={40}>
                        <Spin spinning={!!loadingUserInfo} tip="加载中...">
                            ...
                            <ul>
                                <li><Icon type="team" className={styles.icon}/>{account.ability}用户</li>
                ...
                <Col span={16} xs={24} sm={16} md={16} lg={16}>
                    <Tabs>
                        <Tabs.TabPane key="posts"
                                      tab={<span><Icon type="file-text"/>{isSelf ? '我' : '他或她 '}的帖子</span>}>
                            <PostsListBody
